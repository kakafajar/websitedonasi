            ...
            <div class="carousel-item active">
                <div class="image-container">
                    ...
                    <div class="overlay" data-aos="zoom-out">
                        <h1 class="text-center text-white">Selamat Datang Di Saung Do'a Anak Yatim dan Dhuafa</h1>
                        <p class="text-center text-white">Empowering the future through charity</p>
                    </div>
                </div>
            </div>
        ...
        <div class="p-3" style="background-color: #fff;">
            <div class="container">
                <div class="row gx-4 align-items-center">
                    <div class="col-md-6">
                        <div class="me-md-2 me-lg-5" data-aos="fade-up">
                            <img class="img-fluid rounded-3" src="views/img/bg2.jpg">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="ms-md-2 ms-lg-5 mt-5 mt-md-0" data-aos="fade-left">
                            <h2 class="display-5 fw-bold">Tentang Pesantren</h2>
                            <p class="lead">Pondok Pesantren Sayad Islamic Boarding School adalah lembaga pendidikan Agama yang ber-manhaj Ahluss sunah wal Jama'ah. </p>
                            <a class="btn" style="background-color: #28a745; color:#fff;" href="tentang.html">Learn more</a>
                        </div>
                    </div>
                </div>
            </div>
